...
<head>
    ...
    <style>
        ...
        .fw-bold {
            ...
            margin-bottom: 0px; /* Add space below the name */
        }
        .signature .position {
            font-family: 'Roboto Slab', serif;
            font-size: 16px;
            ...
            margin-top: 0px; /* Adjust the spacing to position the text below "Nithin N" */
        }
        .address-footer {
            font-family: 'Times New Roman', serif;
            font-size: 14px;
            ...
            top: 55px; /* Adjust this value to move the address section down */
        }
        .contact {
            font-weight: bold;
            font-size: 16px;
